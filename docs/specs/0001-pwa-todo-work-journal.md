...
作为需要高频记录与汇报的职场工作者，我需要：

1. 管理每日工作任务（to-do list），用优先级和紧急区区分轻重缓急
2. 追踪长期项目的子任务推进，避免"一周下来好像啥都没干"
3. 每周/每月自动从日常记录生成工作小结汇报（含量化产出汇总）
4. 年底从全年记录生成年度总结，按日常工作、项目推进、协作沟通等维度归纳，支撑年度复盘与述职
5. 在受限的办公电脑（不便安装额外软件）和个人手机之间同步数据
...
16. 作为用户，我想年度报告按日常工作、项目推进、协作沟通、会议培训、临时交办等维度自动归纳，列出每个维度的关键业绩和工作量
...
21. 作为用户，我想在年终时把年度小结草稿 + 团队/部门年度工作计划一起交给 AI 做"计划对齐"分析，体现工作契合组织发展
...
35. 作为用户，我想办公电脑上不引入额外常驻进程——只用浏览器打开 PWA，不改动系统环境
