...
vi.mock('../TaskCard.module.css', () => ({
  default: {
    ...
    subtaskProgressTrack: 'subtaskProgressTrack',
    subtaskProgressFill: 'subtaskProgressFill',
    subtaskProgressCount: 'subtaskProgressCount',
...
function makeTask(overrides?: Partial<Task>): Task {
  return {
    ...
    completedDate: null,
    quantities: [],
    subtasks: [{ id: 's1', title: '步骤一', status: 'todo' }],
    notes: '',
